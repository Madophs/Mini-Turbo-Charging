...
int Utils::setDatetime(std::string datetime, tm &struct_datetime, std::string format, char date_separator, char time_separator) {
	...
	if (Utils::setDate(date, struct_datetime, date_format, date_separator) != 0)
		return FAIL;
	if (Utils::setTime(time, struct_datetime, time_format, time_separator) != 0)
		return FAIL;
	return SUCCESS;
}

int Utils::setDate(std::string date, tm &datetime, std::string format, char separator) {
...
int Utils::setTime(std::string time, tm &datetime, std::string format, char separator) {
